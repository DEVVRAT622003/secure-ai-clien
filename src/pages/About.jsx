  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 min-h-screen mt-16">
      ...
      <div className="text-gray-800 text-lg lg:text-xl text-start">
        <p>
          Welcome to <span className="font-bold text-[#D04E68]">SecureAI</span>, where AI meets innovation to elevate your
          ...
          <span className="font-bold text-[#D04E68]">* Person Detection:</span>  Our AI technology accurately identifies and
          ...
          <span className="font-bold text-[#D04E68]">* Video Recording:</span> Automatically records a 30-second video clip when a
          person is detected, capturing crucial moments for later review and
          analysis. <br /><span className="font-bold text-[#D04E68]">* Surrounding Photo Capture:</span>  In addition to video, our
